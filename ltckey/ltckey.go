...
// PublicKey represents a Litecoin public key.
type PublicKey struct {
	Point
}

// PrivateKey represents a Litecoin private key.
...
// derive derives a Litecoin public key from a Litecoin private key.
